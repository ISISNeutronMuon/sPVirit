...
use crate::pva_client::search::resolve_pv_server;
use crate::pva_client::transport::{read_packet, read_until};
use crate::pva_client::types::{PvGetError, PvGetOptions, PvGetResult};
use pva_codec::epics_decode::{decode_string, PvaPacket, PvaPacketCommand, PvaStatus};
...
fn authnz_user_override(opts: &crate::pva_client::types::PvGetOptions) -> Option<String> {
    opts.authnz_user.clone()
}

fn authnz_host_override(opts: &crate::pva_client::types::PvGetOptions) -> Option<String> {
...
pub fn build_client_validation(
    opts: &crate::pva_client::types::PvGetOptions,
    version: u8,
    is_be: bool,
) -> Vec<u8> {
