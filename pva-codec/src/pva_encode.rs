...
use pva_types::{NtPayload, NtScalar};
use crate::pvd_decode::StructureDesc;
use crate::pvd_encode::{
...
mod tests {
    ...
    fn get_data_response_includes_status() {
        let nt = NtScalar::from_value(pva_types::ScalarValue::F64(1.0));
    ...
    fn put_get_init_includes_two_descriptors() {
        let nt = NtScalar::from_value(pva_types::ScalarValue::F64(1.0));
        let desc = crate::pvd_encode::nt_scalar_desc(&nt.value);
    ...
    fn put_get_data_includes_status() {
        let nt = NtScalar::from_value(pva_types::ScalarValue::F64(2.0));
    ...
    fn encode_get_field_response_roundtrip() {
        let desc = StructureDesc {
            ...
            fields: vec![crate::pvd_decode::FieldDesc {
                name: "value".to_string(),
                field_type: crate::pvd_decode::FieldType::Scalar(
                    crate::pvd_decode::TypeCode::String,
                ),
            }],
        };
