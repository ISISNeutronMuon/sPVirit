...
use crate::pva_encode::format_pva_address;
use crate::pvd_decode::{format_compact_value, DecodedValue, PvdDecoder, StructureDesc};
...
mod tests {
    ...
    use crate::pva_encode::encode_header;
    use crate::pvd_decode::extract_nt_scalar_value;
